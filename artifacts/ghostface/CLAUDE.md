# GHOSTFACE mobile app — working agreement

Scoped to this directory (`artifacts/ghostface/`) — see the repo-root
`CLAUDE.md` for repo-wide rules (STATUS.md/TRACKER.md, repo layout,
report-before-writing-code, dependency approval).
